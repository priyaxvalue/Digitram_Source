...
@interface ReceptionViewController ()<UIPopoverControllerDelegate, MFMailComposeViewControllerDelegate,SignaVCDelegate, UITextViewDelegate>
...
- (void)viewDidLoad
{
    [super viewDidLoad];
    saved_Into_DB=NO;
    [self.scrollView setContentSize:(CGSizeMake(768, 4500))];
