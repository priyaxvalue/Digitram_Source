//
//  AdequacyViewController.h
//  Digitram
//
//  Created by Ravi on 21/05/15.
//  Copyright (c) 2015 Balladonia iTechnologies. All rights reserved.
//

#import <UIKit/UIKit.h>

@interface AdequacyViewController : UIViewController
...
@property(nonatomic)IBOutlet NSString *b1, *b2, *b3, *b4, *b5, *b6, *b7, *b8, *b9, *b10, *b11, *b12, *b13, *b14, *b15, *b16, *b17, *b18, *b19, *b20, *b21, *b22, *b23, *b24, *b25, *b26, *b27;

@property(nonatomic)BOOL confirmpdf;
@property(nonatomic,retain)IBOutlet NSMutableArray *dataarray, *dataarray1, *imagearray, *imagearray1;
...
@property(nonatomic,retain)IBOutlet UIButton *editsig1;
@property(nonatomic,retain)IBOutlet UIButton *editsig2;
