...
@interface CauserieQSSEViewController ()<MFMailComposeViewControllerDelegate, SignaVCDelegate,UITextFieldDelegate>


@end

@implementation CauserieQSSEViewController
...
//    }
    ...
    {
        txt_poleqsse.text=self.dataarray[0];
        
        txt_Reference.text=self.dataarray[1];
        txt_animateur.text=self.dataarray[2];
        txt_date.text=self.dataarray[3];
        txt_Themes.text=self.dataarray[4];
        
        txt_nom_prenom1.text=self.dataarray[5];
        txt_nom_prenom2.text=self.dataarray[6];
        txt_nom_prenom3.text=self.dataarray[7];
        txt_nom_prenom4.text=self.dataarray[8];
        txt_nom_prenom5.text=self.dataarray[9];
        txt_nom_prenom6.text=self.dataarray[10];
        txt_nom_prenom7.text=self.dataarray[11];
        txt_nom_prenom8.text=self.dataarray[12];
        txt_nom_prenom9.text=self.dataarray[13];
        txt_nom_prenom10.text=self.dataarray[14];
        
        txt_Commentaires.text=self.dataarray[15];
        txt_Remarques.text=self.dataarray[16];
        txt_Proposition.text=self.dataarray[17];
        txt_Pilote.text=self.dataarray[18];
        txt_Delai.text=self.dataarray[19];
        txt_Realise.text=self.dataarray[20];
        
        txt_Nom.text=self.dataarray[21];
        
         //// For signature
        if (self.imagearray1.count!=0)
        {
            NSString *datas1=self.imagearray1[0];
            NSData *data1=[[NSData alloc]initWithBase64EncodedData:datas1 options:NSDataBase64DecodingIgnoreUnknownCharacters];
            UIImage *image1=[[UIImage alloc]init];
            image1=[UIImage imageWithData:data1];
            [self.img_Sign1 setImage:image1];
        ...
        {
            NSString *datas2=self.imagearray2[0];
            NSData *data2=[[NSData alloc]initWithBase64EncodedData:datas2 options:NSDataBase64DecodingIgnoreUnknownCharacters];
            UIImage *image2=[[UIImage alloc]init];
            image2=[UIImage imageWithData:data2];
            [self.img_Sign2 setImage:image2];
        ...
        {
            NSString *datas3=self.imagearray3[0];
            NSData *data3=[[NSData alloc]initWithBase64EncodedData:datas3 options:NSDataBase64DecodingIgnoreUnknownCharacters];
            UIImage *image3=[[UIImage alloc]init];
            image3=[UIImage imageWithData:data3];
            [self.img_Sign3 setImage:image3];
        ...
        {
            NSString *datas4=self.imagearray4[0];
            NSData *data4=[[NSData alloc]initWithBase64EncodedData:datas4 options:NSDataBase64DecodingIgnoreUnknownCharacters];
            UIImage *image4=[[UIImage alloc]init];
            image4=[UIImage imageWithData:data4];
            [self.img_Sign4 setImage:image4];
        ...
        {
            NSString *datas5=self.imagearray5[0];
            NSData *data5=[[NSData alloc]initWithBase64EncodedData:datas5 options:NSDataBase64DecodingIgnoreUnknownCharacters];
            UIImage *image5=[[UIImage alloc]init];
            image5=[UIImage imageWithData:data5];
            [self.img_Sign5 setImage:image5];
        ...
        {
            NSString *datas6=self.imagearray6[0];
            NSData *data6=[[NSData alloc]initWithBase64EncodedData:datas6 options:NSDataBase64DecodingIgnoreUnknownCharacters];
            UIImage *image6=[[UIImage alloc]init];
            image6=[UIImage imageWithData:data6];
            [self.img_Sign6 setImage:image6];
        ...
        {
            NSString *datas7=self.imagearray7[0];
            NSData *data7=[[NSData alloc]initWithBase64EncodedData:datas7 options:NSDataBase64DecodingIgnoreUnknownCharacters];
            UIImage *image7=[[UIImage alloc]init];
            image7=[UIImage imageWithData:data7];
            [self.img_Sign7 setImage:image7];
        ...
        {
            NSString *datas8=self.imagearray8[0];
            NSData *data8=[[NSData alloc]initWithBase64EncodedData:datas8 options:NSDataBase64DecodingIgnoreUnknownCharacters];
            UIImage *image8=[[UIImage alloc]init];
            image8=[UIImage imageWithData:data8];
            [self.img_Sign8 setImage:image8];
        ...
        {
            NSString *datas9=self.imagearray9[0];
            NSData *data9=[[NSData alloc]initWithBase64EncodedData:datas9 options:NSDataBase64DecodingIgnoreUnknownCharacters];
            UIImage *image9=[[UIImage alloc]init];
            image9=[UIImage imageWithData:data9];
            [self.img_Sign9 setImage:image9];
        ...
        {
            NSString *datas10=self.imagearray10[0];
            NSData *data10=[[NSData alloc]initWithBase64EncodedData:datas10 options:NSDataBase64DecodingIgnoreUnknownCharacters];
            UIImage *image10=[[UIImage alloc]init];
            image10=[UIImage imageWithData:data10];
            [self.img_Sign10 setImage:image10];
        ...
        {
            NSString *datas11=self.imagearray11[0];
            NSData *data11=[[NSData alloc]initWithBase64EncodedData:datas11 options:NSDataBase64DecodingIgnoreUnknownCharacters];
            UIImage *image11=[[UIImage alloc]init];
            image11=[UIImage imageWithData:data11];
            [self.img_Signature_Nom setImage:image11];
...
{
    txt_poleqsse.userInteractionEnabled=FALSE;
    
    txt_Reference.userInteractionEnabled=FALSE;
    txt_animateur.userInteractionEnabled=FALSE;
    txt_date.userInteractionEnabled=FALSE;
    txt_Themes.userInteractionEnabled=FALSE;
    
    txt_nom_prenom1.userInteractionEnabled=FALSE;
    txt_nom_prenom2.userInteractionEnabled=FALSE;
    txt_nom_prenom3.userInteractionEnabled=FALSE;
    txt_nom_prenom4.userInteractionEnabled=FALSE;
    txt_nom_prenom5.userInteractionEnabled=FALSE;
    txt_nom_prenom6.userInteractionEnabled=FALSE;
    txt_nom_prenom7.userInteractionEnabled=FALSE;
    txt_nom_prenom8.userInteractionEnabled=FALSE;
    txt_nom_prenom9.userInteractionEnabled=FALSE;
    txt_nom_prenom10.userInteractionEnabled=FALSE;
    
    txt_Commentaires.userInteractionEnabled=FALSE;
    txt_Remarques.userInteractionEnabled=FALSE;
    txt_Proposition.userInteractionEnabled=FALSE;
    txt_Pilote.userInteractionEnabled=FALSE;
    txt_Delai.userInteractionEnabled=FALSE;
    txt_Realise.userInteractionEnabled=FALSE;
    
    txt_Nom.userInteractionEnabled=FALSE;
    ...
    self.btn_Edit.userInteractionEnabled=FALSE;
