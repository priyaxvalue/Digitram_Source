...
- (void)viewDidLoad
{
    ...
    //1,928
    str_DocumentName = @"QE7130TR ATC Attestation de consignation" ;
...
-(void)redirect
{
    ...
    NSMutableArray *arraydata=[[NSMutableArray alloc]initWithObjects: txtConsignation_m.text,txtEnterprise.text,txtConsignee_a.text,txtConsignee_h.text,txtConsignee_mn.text,txtRisques.text,txtSuivants.text,txtTermines_a.text,txtTermines_h.text,txtTermines_mn.text,txtNecessaires.text,txtRepresentant.text,txtDeconsignation_a.text,txtDeconsignation_h.text,txtDeconsignation_mn.text,txtNom_remplace.text,txtNom_remplacant.text,txtSign_consignation_a.text,txtSign_consignation_h.text,txtSign_consignation_mn.text,txtDelegation_represent.text,txtDelegation_demande.text,txtDelegation_charge.text,txtd_effectuer_les.text,txtDelegation_a.text,txtDelegation_h.text,txtDelegation_mn.text,txtDelegation_risques.text,txtPlus_tard_a.text,txtPlus_tard_h.text,txtPlus_tard_mn.text,txtdecharge_represendant.text,txtdecharge_de_toutes.text,txtdecharge_de_travaux.text,txtdecharge_suivant.text,txtdecharge_duree_de.text,txtdecharge_date.text,txtdecharge_heure.text,nil];
    ...
    NSMutableArray *arrayimg2=[[NSMutableArray alloc]initWithObjects:str_img3, nil];
    NSMutableArray *arrayimg3=[[NSMutableArray alloc]initWithObjects:str_img4, nil];
    NSMutableArray *arrayimg4=[[NSMutableArray alloc]initWithObjects:str_img5, nil];
    NSMutableArray *arrayimg5=[[NSMutableArray alloc]initWithObjects:str_img6, nil];
    NSMutableArray *arrayimg6=[[NSMutableArray alloc]initWithObjects:str_img7, nil];
    NSMutableArray *arrayimg7=[[NSMutableArray alloc]initWithObjects:str_img8, nil];
    NSMutableArray *arrayimg8=[[NSMutableArray alloc]initWithObjects:str_img9, nil];
    NSMutableArray *arrayimg9=[[NSMutableArray alloc]initWithObjects:str_img10, nil];
    NSMutableArray *arrayimg10=[[NSMutableArray alloc]initWithObjects:str_img11, nil];
    NSMutableArray *arrayimg11=[[NSMutableArray alloc]initWithObjects:str_img12, nil];
    
    UIStoryboard *sb=[UIStoryboard storyboardWithName:@"Main" bundle:nil];
    ConsignmentViewController *cgvc=[sb instantiateViewControllerWithIdentifier:@"consignmentnew"];
    cgvc.dataarray=arraydata;
    cgvc.imagearray=arrayimg;
    cgvc.imagearray1=arrayimg1;
    cgvc.imagearray2=arrayimg2;
    cgvc.imagearray3=arrayimg3;
    cgvc.imagearray4=arrayimg4;
    cgvc.imagearray5=arrayimg5;
    cgvc.imagearray6=arrayimg6;
    cgvc.imagearray7=arrayimg7;
    cgvc.imagearray8=arrayimg8;
    cgvc.imagearray9=arrayimg9;
    cgvc.imagearray10=arrayimg10;
    cgvc.imagearray11=arrayimg11;
    cgvc.confirmpdf=YES;
    cgvc.retrievedarray=self.retrievedarray;
    if (self.IsForUpdating==YES)
    {
        cgvc.IsForUpdating=YES;
    }
