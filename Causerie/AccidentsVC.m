...
@interface AccidentsVC()<UIPopoverControllerDelegate, MFMailComposeViewControllerDelegate, SignaVCDelegate>

@end

@implementation AccidentsVC
...
-(void)redirect
{
    ...
    NSMutableArray *arraydata=[[NSMutableArray alloc]initWithObjects: b1,b2,self.empl.text,self.emp_n_rue_bp.text, self.emp_code_postal.text, self.emp_commune.text, self.accid.text,self.acc_fonction.text, self.acc_anciennete_au_poste.text, self.acc_qualification.text, b3, b4, b5,self.acc_jour_de_laccident.text, self.dateacctf.text, b6, b7,b8, b9, b10, b11, self.accident_excercait_elle.text, self.lieu_n_rue_bp.text, self.lieu_code_postal.text, self.lieu_commune.text, self.temoin_immediat.text, self.premiere_prosonne_ayent.text, self.textview1.text, self.siege_des_lesions.text, self.nature_des_lesions.text, self.textview2.text, self.textview3.text, self.textview4.text, self.donnes_le_date.text, b12, b13, b14, self.premiers_N_rue_bp.text, self.premiers_code_postal.text, self.premiers_commune.text, b15, b16, self.donnees_si_non_preciser.text, b17, b18, self.premiers_excercait_elle.text, self.donnees_concernant_mesure.text, b19, self.vswtf.text, self.daystf.text, b21, b22, self.textview5.text, self.declarant_name.text, self.declarant_a.text, self.decdatetf.text, self.information_du_chsct.text, self.infdatetf.text, self.annee.text, self.classement_no.text, self.pris_no.text, self.pris_a.text, self.prisdatetf.text, self.txt_consequences.text,nil];

    NSMutableArray *arrayimg=[[NSMutableArray alloc]initWithObjects:str_Sign1, nil];
    NSMutableArray *arrayimg1=[[NSMutableArray alloc]initWithObjects:str_Sign2, nil];
    
    UIStoryboard *sb=[UIStoryboard storyboardWithName:@"Main" bundle:nil];
    AccidentViewController *acvc=[sb instantiateViewControllerWithIdentifier:@"accidentnew"];
    acvc.dataarray=arraydata;
    acvc.imagearray=arrayimg;
    acvc.imagearray1=arrayimg1;
    acvc.confirmpdf=YES;
    
    if (self.IsForUpdating==YES)
    {
        acvc.IsForUpdating=YES;
    }
...
-(void)saveToDataBase: ( UIBarButtonItem *) currentBarButton
{
    ...
    else
    {
        if (saved_Into_DB==NO)
        {
            ...
            NSString *strQuery = [NSString stringWithFormat:@"insert into accident_immediate(accident_id,doc_name,accident_de_travail,accident_sur_le_travail,empl_nom,emp_n_rue_bp,emp_code_postal,emp_commune,accid_nom,acc_fonction,acc_anciennete_au_poste,acc_qualification,acc_con_du_poste_tb,acc_con_du_poste_b,acc_con_du_poste_m,acc_jour_de_laccident,acc_date,lieu_habituel_chantier,bureau,atelier,occasionel,au_moment_de_habituelle_oui,au_moment_de_habituelle_non,accident_excercait_elle,lieu_n_rue_bp,lieu_code_postal,lieu_commune,temoin_immediat,premiere_prosonne_ayent,precisez_lactivite,siege_des_lesions,nature_des_lesions,details_et_circonstance,comment_la_victime,quels_evenements_deviant,donnes_le_date,donnesle_par_sst,donnesle_par_medecin,donnesle_par_ets_hospitalier,premiers_N_rue_bp,premiers_code_postal,premiers_commune,donnees_concernant_oui1,donnees_concernant_non1,donnees_si_non_preciser,donnees_concernant_oui2,donnees_concernant_non2,premiers_excercait_elle,donnees_concernant_mesure,conseq_la_victime_travail,conseq_la_victime_a_interrompu,la_victim_date,la_victim_days,afeectation_possible_oui,afeectation_possible_non,measure_prises_ou,declarant_name,declarant_a,declarant_date,declarant_signature,information_du_chsct,information_date,annee,classement_no,pris_no,pris_a,pris_le,pris_sign,doc_created_date,doc_modified_date,consequences) values (\"%d\",\"%@\", \"%@\", \"%@\",\"%@\", \"%@\",\"%@\", \"%@\", \"%@\",\"%@\", \"%@\", \"%@\",\"%@\", \"%@\", \"%@\",\"%@\", \"%@\", \"%@\",\"%@\", \"%@\", \"%@\", \"%@\",\"%@\", \"%@\", \"%@\",\"%@\", \"%@\", \"%@\",\"%@\", \"%@\", \"%@\",\"%@\", \"%@\", \"%@\",\"%@\", \"%@\", \"%@\",\"%@\", \"%@\", \"%@\",\"%@\", \"%@\", \"%@\", \"%@\", \"%@\",\"%@\", \"%@\", \"%@\",\"%@\", \"%@\", \"%@\", \"%@\", \"%@\", \"%@\", \"%@\",\"%@\", \"%@\", \"%@\",\"%@\", \"%@\", \"%@\",\"%@\",\"%@\",\"%@\",\"%@\",\"%@\",\"%@\",\"%@\",\"%@\",\"%@\",\"%@\")",++CurrentCount,str_DocumentName,b1,b2,self.empl.text,self.emp_n_rue_bp.text, self.emp_code_postal.text, self.emp_commune.text, self.accid.text,self.acc_fonction.text, self.acc_anciennete_au_poste.text, self.acc_qualification.text, b3, b4, b5,self.acc_jour_de_laccident.text, self.dateacctf.text, b6, b7,b8, b9, b10, b11, self.accident_excercait_elle.text, self.lieu_n_rue_bp.text, self.lieu_code_postal.text, self.lieu_commune.text, self.temoin_immediat.text, self.premiere_prosonne_ayent.text, self.textview1.text, self.siege_des_lesions.text, self.nature_des_lesions.text, self.textview2.text, self.textview3.text, self.textview4.text, self.donnes_le_date.text, b12, b13, b14, self.premiers_N_rue_bp.text, self.premiers_code_postal.text, self.premiers_commune.text, b15, b16, self.donnees_si_non_preciser.text, b17, b18, self.premiers_excercait_elle.text, self.donnees_concernant_mesure.text, b19, b20, self.vswtf.text, self.daystf.text, b21, b22, self.textview5.text, self.declarant_name.text, self.declarant_a.text, self.decdatetf.text, str_Sign1, self.information_du_chsct.text, self.infdatetf.text, self.annee.text, self.classement_no.text, self.pris_no.text, self.pris_a.text, self.prisdatetf.text, str_Sign2, str_CreatedDate, str_CreatedDate, self.txt_consequences.text];
        ...
        else if(saved_Into_DB==YES)
        {
            ...
            NSString *updateSQL33 = [NSString stringWithFormat:
                                   @"update accident_immediate set accident_de_travail='%@',accident_sur_le_travail='%@',empl_nom='%@',emp_n_rue_bp='%@',emp_code_postal='%@',emp_commune='%@',accid_nom='%@',acc_fonction='%@',acc_anciennete_au_poste='%@',acc_qualification='%@',acc_con_du_poste_tb='%@',acc_con_du_poste_b='%@',acc_con_du_poste_m='%@',acc_jour_de_laccident='%@',acc_date='%@',lieu_habituel_chantier='%@',bureau='%@',atelier='%@',occasionel='%@',au_moment_de_habituelle_oui='%@',au_moment_de_habituelle_non='%@',accident_excercait_elle='%@',lieu_n_rue_bp='%@',lieu_code_postal='%@',lieu_commune='%@',temoin_immediat='%@',premiere_prosonne_ayent='%@',precisez_lactivite='%@',siege_des_lesions='%@',nature_des_lesions='%@',details_et_circonstance='%@',comment_la_victime='%@',quels_evenements_deviant='%@',donnes_le_date='%@',donnesle_par_sst='%@',donnesle_par_medecin='%@',donnesle_par_ets_hospitalier='%@',premiers_N_rue_bp='%@',premiers_code_postal='%@',premiers_commune='%@',donnees_concernant_oui1='%@',donnees_concernant_non1='%@',donnees_si_non_preciser='%@',donnees_concernant_oui2='%@',donnees_concernant_non2='%@',premiers_excercait_elle='%@',donnees_concernant_mesure='%@',conseq_la_victime_travail='%@',conseq_la_victime_a_interrompu='%@',la_victim_date='%@',la_victim_days='%@',afeectation_possible_oui='%@',afeectation_possible_non='%@',measure_prises_ou='%@',declarant_name='%@',declarant_a='%@',declarant_date='%@',declarant_signature='%@',information_du_chsct='%@',information_date='%@',annee='%@',classement_no='%@',pris_no='%@',pris_a='%@',pris_le='%@',pris_sign='%@',doc_modified_date='%@',consequences='%@' where accident_id='%d'", b1,b2,self.empl.text,self.emp_n_rue_bp.text, self.emp_code_postal.text, self.emp_commune.text, self.accid.text,self.acc_fonction.text, self.acc_anciennete_au_poste.text, self.acc_qualification.text, b3, b4, b5,self.acc_jour_de_laccident.text, self.dateacctf.text, b6, b7,b8, b9, b10, b11, self.accident_excercait_elle.text, self.lieu_n_rue_bp.text, self.lieu_code_postal.text, self.lieu_commune.text, self.temoin_immediat.text, self.premiere_prosonne_ayent.text, self.textview1.text, self.siege_des_lesions.text, self.nature_des_lesions.text, self.textview2.text, self.textview3.text, self.textview4.text, self.donnes_le_date.text, b12, b13, b14, self.premiers_N_rue_bp.text, self.premiers_code_postal.text, self.premiers_commune.text, b15, b16, self.donnees_si_non_preciser.text, b17, b18, self.premiers_excercait_elle.text, self.donnees_concernant_mesure.text, b19, b20, self.vswtf.text, self.daystf.text, b21, b22, self.textview5.text, self.declarant_name.text, self.declarant_a.text, self.decdatetf.text, str_Sign1, self.information_du_chsct.text, self.infdatetf.text, self.annee.text, self.classement_no.text, self.pris_no.text, self.pris_a.text, self.prisdatetf.text, str_Sign2, datestring12,self.txt_consequences.text, CurrentCount];
...
- (IBAction)buttonclicked:(id)sender
{
    ...
    if(but.tag==3)
    {
        ...
        else if (self.btb.currentBackgroundImage==[UIImage imageNamed:@"whitebg.gif"])
        {
            b3=@"NO";
        }
