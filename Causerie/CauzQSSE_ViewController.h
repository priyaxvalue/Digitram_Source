//
//  CauzQSSE_ViewController.h
//  hero
//
//  Created by Balladonia iTechnologies on 16/02/15.
...
@interface CauzQSSE_ViewController : UIViewController < UIGestureRecognizerDelegate,UIAlertViewDelegate ,UITextViewDelegate>
{
    CGPoint lastPoint;
...
//@property (strong, nonatomic) IBOutlet UITextField *txt_Theme;
